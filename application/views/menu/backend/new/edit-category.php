            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <div class="offset-md-4 col-md-4">
                  ...
                  <form action="<?= base_url()?>Administrator/updateCategory" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="ids" value="<?= $ctg["idCtg"];?>">
                    <div class="form-group">
                      <label>Nama Kategori</label>
                      <input type="text" name="ctgName" class="form-control" placeholder="Nama kategori" value="<?= $ctg["ctgName"];?>">
                    </div>
                    <div class="form-group">
