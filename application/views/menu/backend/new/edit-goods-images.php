      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Edit Gambar Barang</h1>

            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit Gambar Barang</h6>
              </div>
              <div class="card-body">
                <div class="offset-md-2 col-md-8">
                  <?php if(isset($error)) { echo $error; }?>
                  <?php echo validation_errors(); ?>
                  <h4>Yang Sudah Diupload</h4>
                  <div class="row mb-3">                    
                    <?php foreach ($pics as $pic) { ?>
                      <div class="col-md-3">
                        <img src="<?= base_url()?>assets/uploads/goods/<?= $pic->imgPath?>" alt="" width="100%" class="img-responsive img-thumbnail">
                        <button type="button" class="btn btn-sm btn-danger" onclick="removeImages(<?= $pic->imgToken; ?>)"><i class="fas fa-fw fa-trash"></i></button>
                      </div>
                    <?php }?>
                  </div>
