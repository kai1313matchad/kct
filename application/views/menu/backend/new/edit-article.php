            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <div class="offset-md-2 col-md-8">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <img src="<?= base_url()?>assets/uploads/news/<?= $art["path"]?>" alt="" class="img-thumbnail img-responsive" width="100%">
                    </div>
                  </div>
                  <form action="<?= base_url()?>Administrator/updateArticle" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="ids" value="<?= $art["id_news"];?>">
                    <div class="form-group">
                      <label>Judul</label>
                      <input type="text" name="judulArticle" class="form-control" placeholder="Judul artikel" value="<?= $art["judul"];?>">
                    </div>
                    <div class="form-group">
                      <label>Isi</label>
                      <textarea name="isiArticle" class="form-control textarea"><?= $art["isi"];?></textarea>
                    </div>
                    <div class="form-group">
