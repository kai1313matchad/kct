      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Manage Artikel</h1>
              ...
              <div class="card-body">
                <div class="row mb-2">
                  <div class="offset-8 col-4 text-right">
                    <a href="<?= base_url()?>admin/add-article" class="btn btn-success"><i class="fas fa-fw fa-plus-circle"></i> Tambah</a>
                  </div>
                </div>
    ...
    <script>
      ...
      function dtbSearchList() {
        table = $('#list').DataTable({ 
          ...
          "order": [],
          "ajax": {
            "url": "<?php echo site_url('Administrator/articleList')?>",
            "type": "POST",                
          },
          "columnDefs": [ { 
              "targets": [ 0 ],
