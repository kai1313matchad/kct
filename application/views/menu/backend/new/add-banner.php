      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Tambah Banner</h1>
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <div class="offset-md-4 col-md-4">
                  ...
                  <form action="<?= base_url()?>Administrator/saveBanner" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label>Caption</label>
                      <input type="text" name="captionBanner" class="form-control" placeholder="Caption banner">
                    </div>
                    <div class="form-group">
                      <label>File</label>
