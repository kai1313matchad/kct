            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <div class="offset-md-2 col-md-8">
                  ...
                  <form action="<?= base_url()?>Administrator/saveGoods" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <label>Nama Barang</label>
                      <input type="text" name="itemName" class="form-control" placeholder="Nama barang">
                    </div>
                    <div class="form-group">
                      ...
                      <select name="itemCtg" class="form-control select2">
                        ...
                        <?php foreach ($ctg as $ctg) { ?>
                          <option value="<?= $ctg->idCtg;?>"><?= $ctg->ctgName;?></option>
                        <?php } ?>
                      </select>
                    </div>
                    <div class="form-group">
                      <label>Deskripsi</label>
                      <textarea name="itemDesc" class="form-control textarea"></textarea>
                    </div>
                    <div class="form-group">
                      <label>Harga</label>
                      <input type="text" name="itemPrice" class="form-control num" placeholder="Harga barang">
                    </div>
                    <div class="form-group">
