      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Manage Banner</h1>

            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Banner Collections</h6>
              </div>
              <div class="card-body">
                <div class="row mb-2">
                  <div class="offset-8 col-4 text-right">
                    <a href="<?= base_url()?>admin/add-banner" class="btn btn-success"><i class="fas fa-fw fa-plus-circle"></i> Tambah</a>
                  </div>
                </div>
                <div class="table-responsive">
                  <table class="table table-bordered" id="list" width="100%" cellspacing="0">
                    <thead>
                      <tr>
                        <th class="w-1">#</th>
                        <th class="w-2">Judul</th>
                        <th class="w-5">Gambar</th>
                        <th class="w-3">Caption</th>
