      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Manage Barang</h1>
              ...
              <div class="card-body">
                <div class="row mb-2">
                  <div class="offset-8 col-4 text-right">
                    <a href="<?= base_url()?>admin/add-goods" class="btn btn-success"><i class="fas fa-fw fa-plus-circle"></i> Tambah</a>
                  </div>
                </div>
                  ...
                  <table class="table table-bordered" id="list" width="100%" cellspacing="0">
                    <thead>
                      <tr>
                        <th class="w-1">#</th>
                        <th class="w-2">Img</th>
                        <th class="w-2">Nama</th>
                        <th class="w-1">Kategori</th>
                        <th class="w-4">Deskripsi</th>
    ...
    <script>
      ...
      function dtbSearchList() {
        table = $('#list').DataTable({ 
          ...
          "order": [],
          "ajax": {
            "url": "<?php echo site_url('Administrator/goodsList')?>",
            "type": "POST",                
          },
          "columnDefs": [ { 
              "targets": [ 0 ],
