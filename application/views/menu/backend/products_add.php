<!-- Page Content -->
        <div id="page-wrapper">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-12">
                <h1 class="page-header">Tambah Project</h1>
              </div>
            </div>
          </div>
          <div class="container-fluid">
            <form action="<?php echo base_url() ?>Administrator/insert_products" method="post" enctype="multipart/form-data">
              ...
              <div class="row" style="margin-bottom: 5px;">
                ...
                <div class="col-lg-4">
                  <div class="input-group">
                    ...
                    <input id="klien" type="text" class="form-control" name="klien" placeholder="Nama Klien" />
                  </div>
                </div>
              </div>
              <div class="row" style="margin-bottom: 5px;">
                ...
                <div class="col-lg-4">
                  <div class="input-group">
                    ...
                    <input id="lokasi" type="text" class="form-control" name="lokasi" placeholder="Lokasi proyek/alamat klien" />
                  </div>
                </div>
              </div>
              <div class="row" style="margin-bottom: 5px;">
              ...
              <div class="row">
                <div class="col-lg-4 col-lg-offset-8 text-right">
                  ...
                  <a href="<?php echo base_url() ?>Administrator/add_products" class="btn btn-default" type="submit">Batal</a>
                </div>        
              </div><br>
            </form>
          </div>
