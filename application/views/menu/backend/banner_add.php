<!-- Page Content -->
        <div id="page-wrapper">
            ...
            <!-- /.container-fluid -->
            <div class="container-fluid">
                <form action="<?php echo base_url() ?>Administrator/insert_web_banner" method="post" enctype="multipart/form-data">
                    <div class="row">
                    <?php
                        if($error == true)
                        {?>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-lg-offset-8 text-right">
                            ...
                            <a href="<?php echo base_url() ?>Administrator/add_web_banner" class="btn btn-default" type="submit">
                                Batal
                            </a>
                        </div>                            
                    </div>
