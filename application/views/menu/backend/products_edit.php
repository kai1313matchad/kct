                ...
                <form action="<?php echo base_url() ?>Administrator/update_products" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <select name="ktg" id="kategori" class="form-control input-md select2">
                                <option value="Billboard" <?php if ($kategori == "Billboard") { echo 'selected'; } ?>>
                                    Billboard
                                </option>
                                <option value="Canopy" <?php if ($kategori == "Canopy") { echo 'selected'; } ?>>
                                    Canopy
                                </option>
                                <option value="Exterior-Fascia" <?php if ($kategori == "Exterior-Fascia") { echo 'selected'; } ?>>
                                    Exterior-Fascia
                                </option>
                                <option value="Interior-Fascia" <?php if ($kategori == "Interior-Fascia") { echo 'selected'; } ?>>
                                    Interior-Fascia
                                </option>
                                <option value="LetterSign" <?php if ($kategori == "LetterSign") { echo 'selected'; } ?>>
                                    Letter Sign
                                </option>
                                <option value="Mural" <?php if ($kategori == "Mural") { echo 'selected'; } ?>>
                                    Mural
                                </option>
                                <option value="Neonbox" <?php if ($kategori == "Neonbox") { echo 'selected'; } ?>>
                                    Neonbox
                                </option>
                                <option value="Pylon" <?php if ($kategori == "Pylon") { echo 'selected'; } ?>>
                                    Pylon
                                </option>
                                <option value="Tower-BTS" <?php if ($kategori == "Tower-BTS") { echo 'selected'; } ?>>
                                    Tower-BTS
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-lg-offset-8 text-right">
                            ...
                            <a href="<?php echo base_url() ?>Administrator/edit_products/<?php echo $id_product?>" class="btn btn-default" type="submit">
                                Batal
                            </a>
                        </div>                            
                    </div><br>
