<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Edit Clients</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
            ...
            <!-- /.container-fluid -->
            <div class="container-fluid">
                <form action="<?php echo base_url() ?>Administrator/update_clients" method="post" enctype="multipart/form-data">
                    <div class="row">
                    <?php
                        if($error == true)
                        {?>
                    ...
                    <div class="row">
                        <div class="col-lg-10 col-lg-offset-2">
                            <img src="<?php echo base_url().'assets/uploads/clients/'.$path ?>" class="img-thumbnail upd-banner img-responsive">
                        </div>
                    </div>                 
                    <div class="row">              
                        <div class="col-lg-2">
                    ...
                    <div class="row">                        
                        <div class="col-lg-6 col-lg-offset-2">
                            <label>Ukuran Gambar Optimal : Lebar 250px Tinggi 200px</label><br>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-lg-offset-8 text-right">
                            ...
                            <a href="<?php echo base_url() ?>Administrator/edit_clients/<?php echo $id_client?>" class="btn btn-default" type="submit">
                                Batal
                            </a>
                        </div>                            
                    </div>
