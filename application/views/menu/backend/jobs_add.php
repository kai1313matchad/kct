<!-- Page Content -->
        <div id="page-wrapper">
            ...
            <!-- /.container-fluid -->
            <div class="container-fluid">
                <form action="<?php echo base_url() ?>Administrator/insert_jobs" method="post" enctype="multipart/form-data">
                    <div class="row">                    
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="input-group">
                                ...
                                <input id="lokasi" type="text" class="form-control" name="lokasi" placeholder="Penempatan Kerja" />
                            </div>
                        </div>
                    </div><br>
                    <div class="row">
                        ...
                        <div class='col-lg-4'>
                            <div class="form-group">
                                <div class='input-group date' id='datetimepicker1'>     
                                    ...
                                    <input type='text' class="form-control" name="tgl1" placeholder="Tanggal Mulai" />
                                </div>
                            </div>
                        </div>
                        <div class='col-lg-4'>
                            <div class="form-group">
                                <div class='input-group date' id='datetimepicker2'>
                                    ...
                                    <input type='text' class="form-control" name="tgl2" placeholder="Tanggal Selesai" />
                                </div>
                            </div>
                        </div>
                    </div><br>
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <div class="form-group">
                                <textarea id="desc" name="desc" class="form-control" rows="5" style="resize: vertical;"  ></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <div class="form-group">
                                <textarea id="info" name="info" class="form-control" rows="5" style="resize: vertical;"  ></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4 col-lg-offset-8 text-right">
                            ...
                            <a href="<?php echo base_url() ?>Administrator/add_jobs" class="btn btn-default" type="submit">
                                Batal
                            </a>
                        </div>                            
                    </div><br>
