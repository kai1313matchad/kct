<!-- Page Content -->
        <div id="page-wrapper">
          ...
          <div class="container-fluid">
            <form action="<?php echo base_url() ?>Administrator/insert_news" method="post" enctype="multipart/form-data">
              <div class="row">
                <?php if($error == true) { ?>
                  <div class="col-lg-12">
              ...
              <div class="row">
                ...
                <div class="col-lg-10">
                  <div class="form-group">
                    <textarea id="kutip" name="kutip" class="form-control" rows="5" style="resize: vertical;"  ></textarea>
                  </div>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                <div class="col-lg-4 col-lg-offset-8 text-right">
                  ...
                  <a href="<?php echo base_url() ?>Administrator/add_news" class="btn btn-default" type="submit">Batal</a>
                </div>        
              </div><br>
            </form>
          </div>
