<!-- Page Content -->
        <div id="page-wrapper">
            ...
            <!-- /.container-fluid -->
            <div class="container-fluid">
                <form action="<?php echo base_url() ?>Administrator/update_web_banner" method="post" enctype="multipart/form-data">
                    <div class="row">
                    <?php
                        if($error == true)
                        {?>
                    ...
                    <div class="row">
                        <div class="col-lg-10 col-lg-offset-2">
                            <img src="<?php echo base_url().'assets/uploads/banner/'.$path_banner ?>" class="img-thumbnail upd-banner img-responsive">
                        </div>
                    </div>                 
                    <div class="row">              
                        <div class="col-lg-2">
                    ...
                    <div class="row">                        
                        <div class="col-lg-6 col-lg-offset-2">
                            <label>Ukuran Gambar Optimal : Lebar 1350px Tinggi 540px</label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="input-group">
                                ...
                                <input id="judul" type="text" class="form-control" name="judul" value="<?php echo $judul_banner; ?>" />
                            </div>
                        </div>
                    </div><br>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-lg-offset-8 text-right">
                            ...
                            <a href="<?php echo base_url() ?>Administrator/edit_web_banner/<?php echo $id_banner?>" class="btn btn-default" type="submit">                                
                                Batal
                            </a>
                        </div>                            
                    </div>
