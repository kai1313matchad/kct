    	...
    	<div class="owl-carousel owl-theme full-screen">
	        ...
	        <div class="container d-flex align-items-center h-right">
	          <div class="wrap-caption">
		          <h1 class="caption-heading text-white">INDUSE  <span>Tritunggal Metalworks</span></h1>
	    	...
	    	<!-- Item 2 -->
	    	<div class="item">
	        <img src="<?= base_url()?>assets/v1/images/1920x900/1920x900-2.jpg" alt="Slider">
			  ...
			  <div class="container">
				  <div class="row align-items-end">
					  <div class="col-12 col-md-4">
						  <img src="<?= base_url()?>assets/v1/images/500x880/500x880-1.jpg" class="img-fluid" alt="">
					  </div>
    ...
    <!-- WHY -->
	  ...
	  <!-- CTA -->
	  <div class="section bgi-cover-center bg-overlay-primary" data-background="<?= base_url()?>assets/v1/images/1920x900/1920x900-3.jpg">
		  <div class="content-wrap">
			  <div class="container">
				  <div class="row align-items-center">
					  <div class="col-sm-12 col-md-8 offset-md-2">
						  <div class="cta-info">
							  <h2 class="text-white">All of Our Customers Trust <span class="text-secondary">Their Success To Us</span></h2>
						  </div>
					  </div>
				  </div>
			  </div>
	  ...
	  <div class="section bg-gray-light bgi-cover-center" data-background="<?= base_url()?>assets/v1/images/testmonial-back.png">
		  <div class="content-wrap">
			  <div class="container">
				  <div class="row">
					  <div class="col-sm-12 col-md-12">
						  <h2 class="section-heading mb-5">TESTIMONIALS</h2>
						  <p class="subheading mb-5">We provide high standar clean website for your business solutions</p>
					  </div>
				  </div>
				  <div class="row">
						  ...
						  <div id="carousel3" class="owl-carousel owl-theme">
							  ...
							  <div class="item">
								  <div class="rs-box-testimony">
									  <div class="media-box">
										  <img src="<?= base_url()?>assets/v1/images/dummy-img-400x400.jpg" alt="" class="rounded-circle">
									  </div>
									  <div class="quote-box">
										  <blockquote class="quote">
