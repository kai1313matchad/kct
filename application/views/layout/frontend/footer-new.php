          ...
          <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="footer-item">
                ...
                <p><strong>Tritunggal Metalworks</strong> is a company focused on the field of construction of billboards. </p>
			  ...
			  <div class="container">
				  <div class="row">
					  <div class="col-sm-12 col-md-12 col-lg-12">
						  <p class="mt-3 text-center">Copyright 2020 © <span class="text-secondary">Induse HTML Template</span>. Designed by <span class="text-secondary">Rometheme.</span></p> 
					  </div>
				  </div>
			  </div>
		  </div>
